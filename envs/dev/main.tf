# ==============================================================================
# dev environment — wires the vpc + eks modules together
# ==============================================================================
# Dev is deliberately cheap: single NAT gateway, spot-capable workload pool on
# t3.medium, and a smaller system pool. The architecture is identical to prod;
# only sizing and HA knobs differ.
